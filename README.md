...
### Tech Stack
`Linux`, `Ansible`, `Git`, `Docker`, `Kubernetes`, `Helm`, `CI/CD`, `Jenkins`, `AWS`, `Python`, `Bash`, `Nginx`, `TCP/IP and application layer protocols (HTTP, HTTPS, DNS)`, `Monitoring (Grafana, Prometheus, Icinga2)`.
